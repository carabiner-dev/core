...
// 	protoc        (unknown)
// source: carabiner/v1/core/events.proto
...
func (EventType) Descriptor() protoreflect.EnumDescriptor {
	return file_carabiner_v1_core_events_proto_enumTypes[0].Descriptor()
}

func (EventType) Type() protoreflect.EnumType {
	return &file_carabiner_v1_core_events_proto_enumTypes[0]
}
...
func (EventType) EnumDescriptor() ([]byte, []int) {
	return file_carabiner_v1_core_events_proto_rawDescGZIP(), []int{0}
}
...
func (x *PipelineRun) Reset() {
	*x = PipelineRun{}
	mi := &file_carabiner_v1_core_events_proto_msgTypes[0]
...
func (x *StepRun) Reset() {
	*x = StepRun{}
	mi := &file_carabiner_v1_core_events_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StepRun) Descriptor() ([]byte, []int) {
	return file_carabiner_v1_core_events_proto_rawDescGZIP(), []int{1}
}
...
var file_carabiner_v1_core_events_proto_extTypes = []protoimpl.ExtensionInfo{
	{
...
var (
	...
	E_Name = &file_carabiner_v1_core_events_proto_extTypes[0]
)

var File_carabiner_v1_core_events_proto protoreflect.FileDescriptor
...
var (
	...
	file_carabiner_v1_core_events_proto_rawDescData []byte
)

func file_carabiner_v1_core_events_proto_rawDescGZIP() []byte {
	file_carabiner_v1_core_events_proto_rawDescOnce.Do(func() {
		file_carabiner_v1_core_events_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_carabiner_v1_core_events_proto_rawDesc), len(file_carabiner_v1_core_events_proto_rawDesc)))
	})
	return file_carabiner_v1_core_events_proto_rawDescData
}
...
func init() { file_carabiner_v1_core_events_proto_init() }
func file_carabiner_v1_core_events_proto_init() {
	if File_carabiner_v1_core_events_proto != nil {
		return
	}
	file_carabiner_v1_core_objects_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_carabiner_v1_core_events_proto_rawDesc), len(file_carabiner_v1_core_events_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_carabiner_v1_core_events_proto_goTypes,
		DependencyIndexes: file_carabiner_v1_core_events_proto_depIdxs,
		EnumInfos:         file_carabiner_v1_core_events_proto_enumTypes,
		MessageInfos:      file_carabiner_v1_core_events_proto_msgTypes,
		ExtensionInfos:    file_carabiner_v1_core_events_proto_extTypes,
	}.Build()
	File_carabiner_v1_core_events_proto = out.File
	file_carabiner_v1_core_events_proto_goTypes = nil
	file_carabiner_v1_core_events_proto_depIdxs = nil
}
